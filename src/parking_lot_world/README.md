...
```
  ...
  y=-23.30 └──────────────── 남 벽 ─────────────────┘
 입구(서벽 y=-19.3)
       x=-27.00        주차면 블록 x∈[-17.5,+17.5]        x=+27.00
...
>
> 2026-09-02 에 이미 한 번 넓혔다 (7.0/8.0/7.0 → 8.0/9.0/9.0). 이유는 생성기 상수
...
#   시작 포즈: x=-23.00  y=-19.30  yaw=0  (입구 진입 직후)

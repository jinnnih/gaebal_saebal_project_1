...
| 항목 | 값 |
|---|---|
| 내부 크기 | 56.00 m (X) × 46.60 m (Y) |
| 주차면 | 56 면 — 주차가능 **54**, 빗금 안전지대 2 |
| 초기 점유 | 22 면 (결정론적 배치 → 데모 재현성) |
| 주차면 규격 | 2.50 m × 5.40 m |
| 통로 | 남/북 외곽 8.00 m, 중앙 9.00 m, 동/서 연결차로 10.00 m |
| 구조 기둥 | 0.5 m 각, 16 개 (A/B, C/D 열 경계선 위, 2면마다) |
| 입구 | 서벽 개구부 5.0 m, 중심 y = −19.30, 진입 자세 yaw **45°** |
| 출구 | 동벽 개구부 5.0 m, 중심 y = +19.30 |
| 맵 그리드 | 1160 × 972 px @ 0.05 m/px, origin (−29.00, −24.30) |

### 열(Row) 배치 — 남에서 북으로

```
  y=+23.30 ┌──────────────── 북 벽 ─────────────────┐ ── 출구(동벽 y=+19.3)
           │        Aisle_N  (8.0 m)                │
  y=+15.30 ├────────────────────────────────────────┤
...
#   시작 포즈: x=-24.00  y=-19.30  yaw=45deg  (게이트 통과하며 좌회전 시작)
